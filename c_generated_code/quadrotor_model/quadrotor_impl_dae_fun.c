...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w30;
  ...
  /* #87: @33 = nonzeros(@33) */
  /* #88: @34 = @32[8:11] */
  for (rr=w34, ss=w32+8; ss!=w32+11; ss+=1) *rr++ = *ss;
  /* #89: @33 = (@33*@34) */
  ...
  /* #93: @35 = mac(@36,@34,@35) */
  for (i=0, rr=w35; i<1; ++i) for (j=0; j<3; ++j, ++rr) for (k=0, ss=w36+j, tt=w34+i*3; k<3; ++k) *rr += ss[k*3]**tt++;
  /* #94: @2 = @35[2] */
  ...
  *rr++ = w1;
  /* #116: @34 = @16[1:4] */
  for (rr=w34, ss=w16+1; ss!=w16+4; ss+=1) *rr++ = *ss;
  /* #117: @35 = (@35*@34) */
