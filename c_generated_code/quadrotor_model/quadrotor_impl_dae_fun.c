...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real *w34=w+425, *w35=w+428, *w37=w+440;
  ...
  *rr++ = w01;
  /* #116: @34 = @16[1:4] */
  for (rr=w34, cs=w16+1; cs!=w16+4; cs+=1) *rr++ = *cs;
  /* #117: @35 = (@35*@34) */
  ...
  *rr++ = w28;
  ...
  w04 /= w06;
  /* #139: @37 = (@37*@4) */
  for (i=0, rr=w37; i<3; ++i) (*rr++) *= w04;
  /* #140: @35 = (@35+@37) */
  for (i=0, rr=w35, cs=w37; i<3; ++i) (*rr++) += (*cs++);
  /* #141: @32 = vertcat(@15, @33, @35) */
  rr=w32;
